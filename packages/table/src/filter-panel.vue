...
<script type="text/babel">
  import Popper from 'element-ui-hao/src/utils/vue-popper';
  import { PopupManager } from 'element-ui-hao/src/utils/popup';
  ...
  import ElCheckboxGroup from 'element-ui-hao/packages/checkbox-group';
